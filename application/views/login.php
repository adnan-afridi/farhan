    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-4">
                <div class="logo">
                    <a href="#"><img class="img-responsive" src="<?php echo base_url(); ?>assets/images/logo-img.png" alt="" title=""></a>
                </div>
            </div>
            <div class="col-md-9 col-sm-8">
                <div class="logIn-form pull-right">
                    ...
                    echo form_open(base_url('Main/process_login'), $attributes);
            ...
            <div class="col-md-6">
                <div class="landing-form">
                    ...
                    <div class="form-wrap">
                        ...
                        echo form_open(base_url('Main/register'), $attributes);
