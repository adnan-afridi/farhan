...
//echo $CI->router->class;exit;
        ...
        if ($CI->router->class != "Login" && $CI->router->class != "Main" && $CI->router->method != 'assesment' && $CI->router->method != 'assesment_update' && $CI->router->method != 'getCities' && $CI->router->method != 'getZipCode' && $CI->router->method != 'process_login' && $CI->router->method != 'profile_image') {
