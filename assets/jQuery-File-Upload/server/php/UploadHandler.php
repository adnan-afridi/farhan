...
class UploadHandler {
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => $_SERVER['DOCUMENT_ROOT'].'/reellyou/assets/images/post_images/',
            'upload_url' => $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'].'/reellyou/assets/images/post_images/',
...
//        $CI = get_instance();
//        $CI->load->library('currentuser_session_helper');
...
//        }
//
//        return $userId.'_'.md5(date('Y-m-d H:i:s:u')).$extension;
//    }
...
//
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error, $index = null, $content_range = null) {
        $file = new \stdClass();
        $file->name = $this->get_unique_filename($uploaded_file, $name, $size, $type, $error, $index, $content_range);
